...
static  CGFloat LDrawerLeftViewWidth = 253.0f;    //左边的图层的宽度
...
-(instancetype)initWithCenterController:(UIViewController <LDrawerChild> *)centerController leftController:(UIViewController <LDrawerChild> *)leftController
{
    self = [super init];
    if (self) {
        LDrawerLeftViewWidth = SCREEN_WIDTH - 80;
...
- (void)setIsForbitMove:(BOOL)isForbitMove
{
    _isForbitMove = isForbitMove;
    self.gesture.enabled = !isForbitMove;
}
